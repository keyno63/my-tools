...
export default function MapSVG({ onClickPref }: Props) {
    return (
        <>
            <svg viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                <g
                    className="cursor-pointer hover:opacity-70"
                    fill="#EEEEEE" fill-rule="nonzero" stroke="#000000" stroke-width="1.0"
                    transform="translate(52.000000, 193.000000)"
                    onClick={() => onClickPref("沖縄県")}
                >
                ...
                <g className="boundary-line" stroke="#000000" stroke-width="8" stroke-linejoin="round">
